...
test.describe('atlas-sparkline specimen', function () {
    test('renders an SVG path with numeric coordinates', async function ({ page }) {
    ...
    test('show-last-point variant draws a circle', async function ({ page }) {
        await openSpecimen(page, 'widgets.sparkline');
...
test.describe('atlas-kpi-tile specimen', function () {
    test('renders label, value, and trend elements', async function ({ page }) {
    ...
    test('sparkline variant composes atlas-sparkline inside tile', async function ({ page }) {
        await openSpecimen(page, 'widgets.kpi-tile');
