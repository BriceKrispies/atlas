 ...
 */
import { InMemoryPageStore, ValidatingPageStore, presetLayouts, LayoutRegistry, type LayoutDocument, } from '@atlas/page-templates';
...
export function mountContentPage(demoEl: HTMLElement, ctx: {
    ...
    setProp(page, 'onMediatorTrace', function (evt: unknown) {
        return onLog('mediator', evt);
    });
    setProp(page, 'onCapabilityTrace', function (evt: unknown) {
