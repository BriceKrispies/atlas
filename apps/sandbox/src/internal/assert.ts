 ...
 */
export function customDetail<T>(ev: Event, validate: (d: unknown) => d is T, what: string): T {
...
export function isValueDetail(d: unknown): d is {
    value: string;
} {
    return typeof d === 'object' && d !== null && typeof (d as {
        value?: unknown;
    }).value === 'string';
}
/** Validator: `{ id: string }`. */
export function isIdDetail(d: unknown): d is {
    id: string;
} {
    return typeof d === 'object' && d !== null && typeof (d as {
        id?: unknown;
 ...
 */
export function parseMountConfig<T>(raw: Record<string, unknown>, shape: {
    [K in keyof T]-?: (v: unknown) => v is NonNullable<T[K]>;
}): Partial<T> {
...
export const v = {
    string: function (x: unknown): x is string {
        return typeof x === 'string';
    },
    number: function (x: unknown): x is number {
        return typeof x === 'number';
    },
    boolean: function (x: unknown): x is boolean {
    ...
    array: function (x: unknown): x is unknown[] {
