 ...
 */
export async function acquireLeadership(ctx: AtlasExecutionContext, sql: postgres.Sql, moduleId: string): Promise<Leadership> {
    ...
    try {
        while (true) {
            const rows = await reserved<Array<{
