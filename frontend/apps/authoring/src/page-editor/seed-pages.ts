...
import type { PageDocument } from '@atlas/page-templates';

export const editorStarterPage: PageDocument = {
...
export const editorBlankPage: PageDocument = {
  pageId: 'editor-blank',
  tenantId: 'acme',
  templateId: 'template.two-column',
  templateVersion: '0.1.0',
...
export const editorSeedPages: PageDocument[] = [editorStarterPage, editorBlankPage];
