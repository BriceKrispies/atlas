/**
 * editor-styles.ts — guaranteed injection of editor chrome styles.
 *
...
const _injectedRoots: WeakSet<Document | ShadowRoot> = new WeakSet();
 ...
 */
export function ensureEditorStyles(elOrRoot?: Node | null): void {
