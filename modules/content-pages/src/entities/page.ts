...
export async function getPageEntity(store: EntityStore, tenantId: string, pageId: string): Promise<PageDocument | null> {
...
export async function putPageEntity(store: EntityStore, doc: PageDocument): Promise<void> {
...
export async function deletePageEntity(store: EntityStore, tenantId: string, pageId: string): Promise<void> {
 ...
 * does that in-memory.
 */
export async function listPageEntities(store: EntityStore, tenantId: string): Promise<PageDocument[]> {
