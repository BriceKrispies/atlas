...
export async function getAuditExportConfig(
  store: EntityStore,
  tenantId: string,
  configId: string,
): Promise<AuditExportConfigDocument | null> {
  const row = await store.get<AuditExportConfigDocument>(
    tenantId,
...
export async function putAuditExportConfig(
  store: EntityStore,
  doc: AuditExportConfigDocument,
): Promise<void> {
...
export async function listAuditExportConfigs(
  store: EntityStore,
  tenantId: string,
): Promise<AuditExportConfigDocument[]> {
  const rows = await store.list<AuditExportConfigDocument>(
    tenantId,
    AUDIT_EXPORT_CONFIG_ENTITY_TYPE,
  );
...
export async function putAuditExportRun(
  store: EntityStore,
  doc: AuditExportRunDocument,
): Promise<void> {
...
export async function listAuditExportRuns(
  store: EntityStore,
  tenantId: string,
): Promise<AuditExportRunDocument[]> {
  const rows = await store.list<AuditExportRunDocument>(
    tenantId,
