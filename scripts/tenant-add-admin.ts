...
import { PostgresEntityStore, PostgresEventStore, PostgresRelationStore, PostgresTenantDbProvider, runMigrations, } from '@atlas/adapter-node';
import { handleInviteIssue, identityDispatcher, } from '@atlas/identity';
...
async function main(): Promise<void> {
    ...
    try {
        ...
        const rows = await controlSql<Array<{
            tenant_id: string;
            status: string;
        }>> `
