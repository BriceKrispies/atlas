...
export class AtlasBottomNav extends AtlasElement {
    ...
    static {
        Object.defineProperty(this.prototype, 'hideAbove', AtlasElement.strAttr('hide-above', ''));
    }
    ...
    private _items(): AtlasBottomNavItem[] {
        return Array.from(this.querySelectorAll<AtlasBottomNavItem>(':scope > atlas-bottom-nav-item'));
    }
    ...
    private _onClick(e: Event): void {
        ...
        const item = path.find(function (n): n is AtlasBottomNavItem {
            return n instanceof Element && n.tagName === 'ATLAS-BOTTOM-NAV-ITEM';
        });
        if (!item)
            return;
    ...
    private _onKey(e: KeyboardEvent): void {
        const items = this._items().filter(function (it) {
        ...
        const focusedTab = eventTarget instanceof Element
            ? items.find(function (it) {
                return it.contains(eventTarget) || it === eventTarget;
            })
            : undefined;
    ...
    private _select(value: string): void {
        ...
        this.dispatchEvent(new CustomEvent<AtlasBottomNavChangeDetail>('change', {
...
export class AtlasBottomNavItem extends AtlasElement {
    ...
    static {
        ...
        Object.defineProperty(this.prototype, 'badgeCount', AtlasElement.strAttr('badge-count', ''));
    }
    static override get observedAttributes(): readonly string[] {
