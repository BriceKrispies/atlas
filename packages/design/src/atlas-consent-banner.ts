...
`);
const ICON_INFO = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="9"/><path d="M12 8h.01M11 12h1v5h1"/></svg>';
const ICON_WARN = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 3l10 18H2z"/><path d="M12 10v5M12 18h.01"/></svg>';
const ICON_DANGER = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="9"/><path d="M9 9l6 6M15 9l-6 6"/></svg>';
export class AtlasConsentBanner extends AtlasElement {
    ...
    override attributeChangedCallback(name: string): void {
        ...
        if (name === 'severity')
            ...
            this._syncTitle();
        else if (name === 'approve-label' || name === 'deny-label')
            this._syncLabels();
    }
    private _buildShell(): void {
        ...
        detailsSlot.addEventListener('slotchange', function () {
    ...
    private _currentSeverity(): AtlasConsentSeverity {
        ...
        if (raw === 'warning' || raw === 'danger' || raw === 'info')
            return raw;
        return 'info';
    }
