...
describe('platform-tenant primitives', function () {
    ...
    it('PLATFORM_ROBOT_PRINCIPAL_ID is a stable kinded id', function () {
    ...
    it('bootstrapPlatformRobot defaults to the platform tenant', function () {
    ...
    it('bootstrapPlatformRobot accepts a customer tenant override', function () {
    ...
    it('PlatformRobotPrincipal has no human-user fields', function () {
        const p = bootstrapPlatformRobot();
