...
test.describe('custom-domain host resolution', function () {
    ...
    test('matching Host + debug-principal → 200 healthz', async function () {
    ...
    test('mismatched Host + debug-principal → 403 PRINCIPAL_INVALID', async function () {
    ...
    test('unregistered Host imposes no constraint → falls through to auth', async function () {
