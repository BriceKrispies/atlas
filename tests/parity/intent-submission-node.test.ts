...
d('[node] intent_submission parity', function () {
    ...
    test('test_submit_intent_with_invalid_schema_returns_error', async function () {
    ...
    test('test_submit_intent_with_schema_mismatch_returns_error', async function () {
    ...
    test('test_submit_intent_with_unknown_action_returns_error', async function () {
    ...
    test('test_multiple_valid_intents_succeed', async function () {
    ...
    test('test_submit_intent_response_carries_tenant_id', async function () {
