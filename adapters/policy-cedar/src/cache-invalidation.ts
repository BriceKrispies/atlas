 ...
 */
export function applyCacheTags(engine: CedarBundleCache, tags: ReadonlyArray<string> | null | undefined): Set<string> {
 ...
 */
export function wirePolicyCacheInvalidation(engine: CedarBundleCache): (tags: ReadonlyArray<string> | null | undefined) => void {
