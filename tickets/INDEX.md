...
- [spec-add-worked-example](seeder/spec-add-worked-example.md) — spec — scoped — → spec-keeper — blocks: phase-1.5
- [spec-streaming-vs-snapshot-clarify](seeder/spec-streaming-vs-snapshot-clarify.md) — spec — scoped — → spec-keeper — blocks: phase-1.5
- [validate-or-throw-split-codes](seeder/validate-or-throw-split-codes.md) — refactor — scoped — → port-adapter-dev
...
- [event-envelope-schema-id-rename](chore/event-envelope-schema-id-rename.md) — chore — scoped — → port-adapter-dev
- [sha256hex-extract-to-platform-core](chore/sha256hex-extract-to-platform-core.md) — chore — scoped — → port-adapter-dev
