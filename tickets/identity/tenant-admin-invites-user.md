...
blocks: []
blocked_by: [chore/podman-machine-windows-pipe-access]  # was [chore/expose-server-bootid-for-i20-probe, atlas-on-atlas/query-catch-all-dispatcher] (both archived 2026-05-21). Re-blocked same day on local podman/Windows named-pipe access — code is complete but pnpm bdd:server can't run end-to-end.
files_in_scope:
